...
const int MIN_CARRIER_FREQ = 12;
const int MAX_CARRIER_FREQ = 840;
...
void setup(){
  ...
  startMozzi(); // :))
  aCarrier2.setFreq(0.33f);
  aCarrier3.setFreq(0.15f);
}
...
void updateControl(){
  ...
  aModulator.setFreq(mod_freq * aCarrier2.next()>>6 * aCarrier3.next()>>6);
